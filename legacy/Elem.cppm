...
// // #include <irrKlang.h>
//
// export module Core.UI.Elem;
//
// export import Core.UI.Cursor;
...
// export namespace UI {
// 	class Elem;
// 	using SoundSource = void*;// irrklang::ISoundSource*;
//
// 	struct ElemDrawer;
// 	class Group;
// 	class Table;
...
// 		int PointCheck{0};
//
// 		virtual ~Elem() noexcept override{
// 			releaseRelativeRef();
// 		}
//
...
//
// 		ext::event_manager inputListener{
