...
export namespace Core::Vulkan{
	...
	class DescriptorLayout : public ext::wrapper<VkDescriptorSetLayout>{
	...
	public:
		...
		[[nodiscard]] DescriptorLayout() = default;
		...
		DescriptorLayout(DescriptorLayout&& other) noexcept = default;

		DescriptorLayout& operator=(const DescriptorLayout& other) = delete;

		DescriptorLayout& operator=(DescriptorLayout&& other) noexcept = default;

		DescriptorLayout(VkDevice device, std::regular_invocable<DescriptorLayout&> auto&& func) : device{device}{
			func(*this);
