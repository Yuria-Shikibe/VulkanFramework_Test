	...
	struct Drawer{
		...
		struct Line{
			...
			static void rectOrtho(
				...
				Line::line(++auto_param, stroke, rect.vert_00(), rect.vert_01(), color, color, cap);
				Line::line(++auto_param, stroke, rect.vert_01(), rect.vert_11(), color, color, cap);
				Line::line(++auto_param, stroke, rect.vert_11(), rect.vert_10(), color, color, cap);
			...
			static void circle(M& auto_param,
				...
				Line::poly(auto_param, stroke, {pos, 0}, getCircleVertices(radius), radius, color);
			}
		};
	};
