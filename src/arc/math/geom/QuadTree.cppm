...
namespace Geom{
	...
	protected:
		...
		bool isInersectedBetween(const ItemTy& subject, const ItemTy& object) const{
			...
			bool intersected = this->obtainItemBound(subject).overlap_Exclusive(this->obtainItemBound(object));
	...
	public:
		...
		bool inbound(const ItemTy& object) const{
			...
			return boundary.overlap_Exclusive(this->obtainItemBound(object));
		}
