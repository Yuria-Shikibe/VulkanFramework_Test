...
export namespace Graphic{
	...
	public:
		...
		[[nodiscard]] constexpr ColorBits rgba8888() const noexcept{
			return (static_cast<ColorBits>(r * 255) << 24 & r_Mask) | (static_cast<ColorBits>(g * 255) << 16 & g_Mask) | (static_cast<ColorBits>(b * 255) << 8 & b_Mask) | (static_cast<ColorBits>(a * 255) & a_Mask);
		}
