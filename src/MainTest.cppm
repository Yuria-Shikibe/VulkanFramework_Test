	...
	void initDefUI(){
		...
		bed.emplaceInit<Core::UI::Embryo_Unsaturated>([](Core::UI::Embryo_Unsaturated& embryo){
			...
			embryo.emplaceInit<Core::UI::ScrollPanel>([](Core::UI::ScrollPanel& pane){
				pane.setItem<Core::UI::FlexTable_Dynamic>([](Core::UI::FlexTable_Dynamic& v){
					v.align = Align::Pos::top_left;
					v.emplaceInit<Core::UI::Slider>([](Core::UI::Slider& slider){
					...
					v.emplaceInit<Core::UI::TextElement>([](Core::UI::TextElement& e){
